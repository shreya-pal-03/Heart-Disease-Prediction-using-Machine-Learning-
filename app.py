...
st.image('https://healthmatters.nyp.org/wp-content/uploads/2020/01/heart-health-tips-article-animation-1200x500.gif')
...
st.sidebar.header('Select Features to predict house disease')
st.sidebar.image('https://media2.giphy.com/avatars/saveaheart/yw5TEQLOFkP1.gif')
all_values = []
